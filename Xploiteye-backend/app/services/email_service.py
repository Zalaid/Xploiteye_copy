...
class EmailService:
    ...
    async def send_scan_report_email(self, to_email: str, scan_target: str, scan_type: str, pdf_path: str) -> bool:
        ...
        try:
            ...
            subject = f"XploitEye Security Scan Report - {scan_target}"

            # Create email body
            message = f"""
Security Scan Report - XploitEye
...
Best regards,
XploitEye Security Team

---
This is an automated report generated by XploitEye.
For support, visit: https://xploiteye.com/support
            """
